...
class SignUpForm(UserCreationForm):
	...
	class Meta:
		model = User
		fields = ('usuario', 'nombre', 'apellido', 'email', 'contraseña1', 'contraseña2')
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['username'].help_text = '<span class="form-text text-muted"><small>Obligatorio. 150 carácteres o menos. Sólo letras, dígitos y @/./+/-/_.</small></span>'

		self.fields['password1'].widget.attrs['class'] = 'form-control'
		self.fields['password1'].widget.attrs['placeholder'] = 'Contraseña'
		self.fields['password1'].label = ''
		self.fields['password1'].help_text = '<ul class="form-text text-muted small"><li>Tu contraseña no puede ser demasiado parecida a tus otros datos personales.</li><li>Su contraseña debe contener al menos 8 caracteres.</li><li>Your password can\'t be a commonly used password.</li><li>Your password can\'t be entirely numeric.</li></ul>'
